    ...
    return SystemModel(
        ...
        components={
            ...
            "app": Component("app", ComponentKind.APP_SERVER, "Storefront app", per_instance_rps=2_000,
                             instances=3, base_latency_ms=8.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            "cache": Component("cache", ComponentKind.CACHE, "Catalog cache", per_instance_rps=60_000,
                               instances=1, base_latency_ms=0.4, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
            "db": Component("db", ComponentKind.SQL_DB, "Orders/catalog DB", per_instance_rps=5_000,
                            instances=1, base_latency_ms=4.0, monthly_cost_per_instance=120, provenance="ASSUMPTION"),
            "search": Component("search", ComponentKind.APP_SERVER, "Product search", per_instance_rps=3_000,
                                instances=1, base_latency_ms=6.0, monthly_cost_per_instance=50, provenance="ASSUMPTION"),
            "pay": Component("pay", ComponentKind.EXTERNAL_API, "Payment provider", per_instance_rps=5_000,
                             instances=1, base_latency_ms=30.0, monthly_cost_per_instance=0, provenance="ASSUMPTION"),
        },
        flows=[
    ...
    return SystemModel(
        ...
        components={
            ...
            "app": Component("app", ComponentKind.APP_SERVER, "App tier", per_instance_rps=2_000,
                             instances=2, base_latency_ms=6.0, monthly_cost_per_instance=35, provenance="ASSUMPTION"),
            ...
            "obj": Component("obj", ComponentKind.OBJECT_STORE, "Object store", per_instance_rps=15_000,
                             instances=1, base_latency_ms=5.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
        },
        flows=[
    ...
    return SystemModel(
        ...
        components={
            ...
            "app": Component("app", ComponentKind.APP_SERVER, "App tier", per_instance_rps=3_000,
                             instances=2, base_latency_ms=4.0, monthly_cost_per_instance=30, provenance="ASSUMPTION"),
            "cache": Component("cache", ComponentKind.CACHE, "Hot-image cache", per_instance_rps=60_000,
                               instances=1, base_latency_ms=0.4, monthly_cost_per_instance=15, provenance="ASSUMPTION"),
            ...
            "obj": Component("obj", ComponentKind.OBJECT_STORE, "Image store", per_instance_rps=20_000,
                             instances=1, base_latency_ms=4.0, monthly_cost_per_instance=25, provenance="ASSUMPTION"),
            "thumb": Component("thumb", ComponentKind.APP_SERVER, "Thumbnail worker", per_instance_rps=2_000,
                               instances=1, base_latency_ms=10.0, monthly_cost_per_instance=25, provenance="ASSUMPTION"),
        },
        flows=[
    ...
    return SystemModel(
        ...
        components={
            ...
            "app": Component("app", ComponentKind.APP_SERVER, "App tier", per_instance_rps=2_500,
                             instances=3, base_latency_ms=6.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            "geo": Component("geo", ComponentKind.APP_SERVER, "Geo index service", per_instance_rps=1_500,
                             instances=3, base_latency_ms=8.0, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
            "cache": Component("cache", ComponentKind.CACHE, "Place cache", per_instance_rps=80_000,
                               instances=1, base_latency_ms=0.4, monthly_cost_per_instance=90, provenance="ASSUMPTION"),
            ...
            "search": Component("search", ComponentKind.APP_SERVER, "Text search", per_instance_rps=3_000,
                                instances=1, base_latency_ms=7.0, monthly_cost_per_instance=50, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "app": Component("app", ComponentKind.APP_SERVER, "Feed API", per_instance_rps=3_000,
                             instances=4, base_latency_ms=4.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            ...
            "graph": Component("graph", ComponentKind.SQL_DB, "Social graph", per_instance_rps=6_000,
                               instances=1, base_latency_ms=5.0, monthly_cost_per_instance=120, provenance="ASSUMPTION"),
            "obj": Component("obj", ComponentKind.OBJECT_STORE, "Media store", per_instance_rps=30_000,
                             instances=1, base_latency_ms=3.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
        },
        flows=[
    ...
    return SystemModel(
        ...
        components={
            ...
            "queue": Component("queue", ComponentKind.QUEUE, "Job queue", per_instance_rps=50_000,
                               instances=1, base_latency_ms=0.5, monthly_cost_per_instance=50, provenance="ASSUMPTION"),
            "runner": Component("runner", ComponentKind.APP_SERVER, "Build runners", per_instance_rps=50,
                                instances=2, base_latency_ms=200.0, monthly_cost_per_instance=75, provenance="ASSUMPTION"),
            ...
            "obj": Component("obj", ComponentKind.OBJECT_STORE, "Artifact store", per_instance_rps=15_000,
                             instances=1, base_latency_ms=5.0, monthly_cost_per_instance=20, provenance="ASSUMPTION"),
        },
    ...
    return SystemModel(
        ...
        components={
            ...
            "worker": Component("worker", ComponentKind.APP_SERVER, "Dispatch workers", per_instance_rps=1_000,
                                instances=3, base_latency_ms=15.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            "gw": Component("gw", ComponentKind.API_GATEWAY, "API gateway", per_instance_rps=30_000,
                            instances=2, base_latency_ms=1.0, monthly_cost_per_instance=50, provenance="ASSUMPTION"),
            ...
            "svc_a": Component("svc_a", ComponentKind.APP_SERVER, "Service A", per_instance_rps=3_000,
                               instances=3, base_latency_ms=5.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            ...
            "svc_c": Component("svc_c", ComponentKind.APP_SERVER, "Service C", per_instance_rps=2_000,
                               instances=2, base_latency_ms=8.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            ...
            "db": Component("db", ComponentKind.SQL_DB, "Shared DB", per_instance_rps=8_000,
                            instances=2, base_latency_ms=4.0, monthly_cost_per_instance=150, provenance="ASSUMPTION"),
            ...
            "registry": Component("registry", ComponentKind.APP_SERVER, "Service discovery", per_instance_rps=10_000,
                                  instances=1, base_latency_ms=2.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
...
def build_payment_system(system_rps: float = 5_000) -> SystemModel:
    ...
    return SystemModel(
        ...
        components={
            "lb": Component("lb", ComponentKind.LOAD_BALANCER, "Load balancer", per_instance_rps=50_000,
                            instances=1, base_latency_ms=0.3, monthly_cost_per_instance=30, provenance="ASSUMPTION"),
            "api": Component("api", ComponentKind.APP_SERVER, "Payments API", per_instance_rps=3_000,
                             instances=3, base_latency_ms=5.0, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
            "ledger": Component("ledger", ComponentKind.SQL_DB, "ACID ledger (replicated)", per_instance_rps=4_000,
                                instances=2, base_latency_ms=5.0, monthly_cost_per_instance=300, provenance="ASSUMPTION"),
            ...
            "fraud": Component("fraud", ComponentKind.APP_SERVER, "Fraud scoring", per_instance_rps=2_000,
                               instances=2, base_latency_ms=10.0, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "geo": Component("geo", ComponentKind.APP_SERVER, "Geo matching", per_instance_rps=2_000,
                             instances=2, base_latency_ms=8.0, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "index": Component("index", ComponentKind.APP_SERVER, "Index shards", per_instance_rps=2_000,
                               instances=4, base_latency_ms=8.0, monthly_cost_per_instance=90, provenance="ASSUMPTION"),
            ...
            "crawler": Component("crawler", ComponentKind.APP_SERVER, "Crawl/index worker", per_instance_rps=500,
                                 instances=2, base_latency_ms=50.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "fetcher": Component("fetcher", ComponentKind.APP_SERVER, "Fetch workers", per_instance_rps=200,
                                 instances=5, base_latency_ms=100.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            "parser": Component("parser", ComponentKind.APP_SERVER, "Parse workers", per_instance_rps=500,
                                instances=3, base_latency_ms=30.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "queue": Component("queue", ComponentKind.QUEUE, "Ingest buffer", per_instance_rps=80_000,
                               instances=1, base_latency_ms=0.3, monthly_cost_per_instance=80, provenance="ASSUMPTION"),
            "writer": Component("writer", ComponentKind.APP_SERVER, "TSDB writers", per_instance_rps=5_000,
                                instances=3, base_latency_ms=3.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            "tsdb": Component("tsdb", ComponentKind.SQL_DB, "Time-series DB", per_instance_rps=8_000,
                              instances=2, base_latency_ms=3.0, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
            "cache": Component("cache", ComponentKind.CACHE, "Hot-window cache", per_instance_rps=100_000,
                               instances=1, base_latency_ms=0.3, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "proxy": Component("proxy", ComponentKind.APP_SERVER, "Cache proxy/router", per_instance_rps=30_000,
                               instances=3, base_latency_ms=0.5, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            "node": Component("node", ComponentKind.CACHE, "Cache nodes", per_instance_rps=100_000,
                              instances=3, base_latency_ms=0.2, monthly_cost_per_instance=120, provenance="ASSUMPTION"),
            "db": Component("db", ComponentKind.SQL_DB, "Backing store", per_instance_rps=8_000,
                            instances=1, base_latency_ms=3.0, monthly_cost_per_instance=90, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "gw": Component("gw", ComponentKind.API_GATEWAY, "Gateway workers", per_instance_rps=20_000,
                            instances=3, base_latency_ms=1.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            ...
            "auth": Component("auth", ComponentKind.APP_SERVER, "Auth/token validation", per_instance_rps=10_000,
                              instances=4, base_latency_ms=2.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
            ...
            "log": Component("log", ComponentKind.QUEUE, "Access-log buffer", per_instance_rps=100_000,
                             instances=1, base_latency_ms=0.2, monthly_cost_per_instance=30, provenance="ASSUMPTION"),
        },
        flows=[
    ...
    return SystemModel(
        ...
        components={
            ...
            "vector": Component("vector", ComponentKind.SQL_DB, "Vector store (pgvector)", per_instance_rps=5_000,
                                instances=1, base_latency_ms=8.0, monthly_cost_per_instance=120, provenance="ASSUMPTION"),
    ...
    return SystemModel(
        ...
        components={
            ...
            "supervisor": Component("supervisor", ComponentKind.APP_SERVER, "Orchestrator", per_instance_rps=300,
                                    instances=3, base_latency_ms=50.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            "worker": Component("worker", ComponentKind.APP_SERVER, "Agent workers", per_instance_rps=200,
                                instances=4, base_latency_ms=80.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
...
def build_mcp_tool_gateway(system_rps: float = 8_000) -> SystemModel:
    ...
    return SystemModel(
        ...
        components={
            "gw": Component("gw", ComponentKind.API_GATEWAY, "API gateway", per_instance_rps=20_000,
                            instances=2, base_latency_ms=1.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            "router": Component("router", ComponentKind.APP_SERVER, "Tool router", per_instance_rps=2_000,
                                instances=5, base_latency_ms=8.0, monthly_cost_per_instance=45, provenance="ASSUMPTION"),
            ...
            "auth": Component("auth", ComponentKind.APP_SERVER, "Auth", per_instance_rps=10_000,
                              instances=2, base_latency_ms=2.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
            ...
            "registry": Component("registry", ComponentKind.SQL_DB, "Tool registry", per_instance_rps=6_000,
                                  instances=1, base_latency_ms=3.0, monthly_cost_per_instance=60, provenance="ASSUMPTION"),
        },
        flows=[
    ...
    return SystemModel(
        ...
        components={
            ...
            "writer": Component("writer", ComponentKind.APP_SERVER, "Span/trace writers", per_instance_rps=4_000,
                                instances=3, base_latency_ms=3.0, monthly_cost_per_instance=40, provenance="ASSUMPTION"),
