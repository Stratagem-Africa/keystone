...
DATA.nodes.forEach(n=>{
  ...
  d.style.setProperty('--pc',provColor[n.provenance]||'var(--steel)');
...
$('#subttl').textContent='Architecture map · every result is engine-computed; every input is declared and carries its provenance';
...
<div class="legend glass">
  <div class="col"><div class="t">Provenance (confidence)</div>
