...
- **Predicted-vs-measured discrepancy as the heart of calibration QA** (now in Phase 3). Their roadmap describes an "acceptance server" that computes the discrepancy between a contributed value and reality and routes it to maintainers — a good target shape for our calibration gate.
